        ...
        <>
          ...
          <div className="cd-section broken-white" id="teams">
            ...
            >
              ...
              <div className="title title-header">CPO & OLEIN</div>
              <Container>
                <div
                  style={{ textAlign: "center" }}
                  className="subheader font-white"
                >
                  CPO & OLEINCPO & OLEINCPO & OLEINCPO & OLEINCPO & OLEIN
                </div>
              </Container>
            </div>
            <div className="team-1 broken-white">
              <Container>
                <Row>
                  <Col md="12">
                    <div style={textTitle}>CPO & OLEIN</div>
                  </Col>
                  <Col md="12">
                    <div className="description font-black" style={textDesc}>
                      CPO dan Olein berasal dari tanaman yang sama yaitu spesies
                      palem yang dikenal sebagai E. Guineesis. Tanaman ini
                      tumbuh di Asia Tenggara, Afrika dan Amerika Latin, dan
                      telah dikonsumsi selama lebih dari 5.000 tahun. • CPO
                      (Minyak kelapa sawit) yang diekstrak dari daging buah E.
                      Guineesis dengan menggunakan tekanan berwarna oranye
                      terang karena tingginya kandungan pigmen karoten.   Minyak
                      sawit secara luas digunakan dalam mentega dan margarin. •
                      Olein, minyak sawit yang diproses lebih lanjut
                      menghasilkan Olein dan Stearin.  Olein berbentuk cair pada
                      suhu kamar dan sangat tahan panas.  Olein dengan warna
                      keemasan digunakan sebagai minyak untuk menggoreng.
                    </div>
                  </Col>
                </Row>
              </Container>
                    ...
                    <Row>
                      ...
                      <Col md="12">
                        <div
                          ...
                          style={textDesc}
                        >
                          CPO dan Olein berasal dari tanaman yang sama yaitu
                          spesies palem yang dikenal sebagai E. Guineesis.
                          Tanaman ini tumbuh di Asia Tenggara, Afrika dan
                          Amerika Latin, dan telah dikonsumsi selama lebih dari
                          5.000 tahun. • CPO (Minyak kelapa sawit) yang
                          diekstrak dari daging buah E. Guineesis dengan
                          menggunakan tekanan berwarna oranye terang karena
                          tingginya kandungan pigmen karoten.   Minyak sawit
                          secara luas digunakan dalam mentega dan margarin. •
                          Olein, minyak sawit yang diproses lebih lanjut
                          menghasilkan Olein dan Stearin.  Olein berbentuk cair
                          pada suhu kamar dan sangat tahan panas.  Olein dengan
                          warna keemasan digunakan sebagai minyak untuk
                          menggoreng.
                        </div>
                      </Col>
                    </Row>
                      ...
                      <Col md="12">
                        ...
                        >
                          <tbody style={{ backgroundColor: "#D1D1D1" }}>
                            ...
                            <tr>
                              <td style={text}>Settlement-to-Market</td>
                              <td style={text}>
                                Penjual dan pembeli dapat melakukan penyerahan
                                dengan cara: • Exchange-for-Physical (EFP); atau
                                • Alternative Delivery Procedure (ADP) Diluar
                                cara tersebut di atas, penjual dan pembeli
                                sepakat untuk menyelesaikan secara tunai{" "}
                              </td>
                            </tr>
                            <tr>
                              <td style={text}>Kualitas</td>
                              <td style={text}>
                                § Asam Lemak Bebas (Free Fatty Acid) maks
                                4,5%; Tingkat Kelembaban dan Kotoran (Moisture
                                and Impurities) maks. 0,5%;
                              </td>
                            </tr>
                          </tbody>
                        </Table>
