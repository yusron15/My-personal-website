const defaultState = {
  ...
  legalitas: {
    ...
    content: {
      ...
      content:
        "BAPPEBTI (Badan Pengawas Perdagangan Berjangka Komoditi) merupakan institusi pemerintah yang berada di bawah naungan Kementerian Perdagangan Republik Indonesia dan bertugas untuk menerbitkan izin usaha baik bagi perusahaan maupun perorangan, membuat peraturan dan tata tertib, melakukan inspeksi dan kontrol terhadap seluruh aktivitas dalam industri pialang berjangka. PT. Topgrowth Futures beroperasi berdasarkan izin dan berada di bawah pengawasan BAPPEBTI, dengan Nomor Izin: No. 300/BAPPEBTI/SI/III/2004.",
      image: ["image1", "image1", "image1", "image1", "image1"]
    }
  },
  Forex: {
    header: "Forex",
    ...
    content: [
      {
        title: "Apa Itu CFD?",
        content:
          "Perdagangan CFD secara online adalah salah satu alat paling fleksibel untuk memanfaatkan pergerakan pasar tanpa mengikat dana dengan memperdagangkan instrumen yang mendasarinya. \r\n            Tidak seperti perdagangan saham, CFD dapat dibeli dan dijual dan memungkinkan Anda untuk mencari keuntungan dari kenaikan maupun penurunan harga pasar. \r\n            CFD menawarkan kesempatan untuk membangun beragam portofolio multi-produk dari satu akun."
      },
      {
        title: "Mengapa Bertransaksi CFD?",
        content:
          "CFD (Contract for Difference) adalah perjanjian untuk menukarkan selisih nilai dari instrumen yang mendasari, misalnya saham, antara waktu saat order dibuka dan ditutup. Perdagangan CFD secara online merupakan cara praktis untuk memperdagangkan pasar bull dan bear yang memungkinkan untuk sell short. Saham dapat dijual dengan harga untung sebelum harga saham tersebut jatuh.\r\n            Produk-produk CFD dapat membantu untuk memanfaatkan modal investasi secara efektif. Akan tetapi, jumlah risiko yang dihadapi juga lebih besar dibandingkan produk konvensional.\r\n            CFD adalah produk yang diperdagangkan dengan menggunakan margin. Dengan demikian, potensi investasi menjadi jauh lebih besar hanya dengan menyetor sebagian kecil dari keseluruhan untuk memperdagangkan nilai kontrak penuh dari produk. Sama seperti perdagangan saham, laba atau rugi ditentukan oleh perbedaan antara harga yang dibeli dan dijual. Tingkat margin yang diperlukan akan bervariasi antara produk CFD.\r\n            Topgrowth menawarkan CFD pada berbagai produk mendasar yang komprehensif, termasuk indeks global, futures, komoditas, dan mata uang."
      },
      {
        title: "CFD Trading Strategis",
        content:
          "CFD adalah alat perdagangan yang menggunakan leverage untuk hampir semua produk keuangan. Produk CFD yang ditawarkan meliputi komoditas berjangka (logam dan produk energi) serta indeks yang terdaftar di berbagai pasar keuangan internasional.\r\n            Satu keuntungan besar yang ditawarkan adalah pengguna tidak perlu menyediakan dana 100% dari nilai nominal produk. Dengan membeli CFD, pengguna sebenarnya tidak memiliki produk yang mendasarinya, tetapi pengguna memiliki hak 100% atas keuntungan atau kerugian dari nilai penuh kontrak.\r\n            Terlepas dari gaya investasi, produk CFD adalah alat yang berharga untuk mengembangkan dan melindungi keseluruhan portofolio. Dengan CFD, pengguna dapat berspekulasi pada pergerakan jangka pendek harga produk keuangan, atau pengguna dapat melindungi posisi portofolio secara keseluruhan untuk meminimalkan pergerakan pasar negatif. Selain itu, pengguna dapat memanfaatkan penggunaan leverage yang ada, yang bergantung pada arah pasar, dan secara signifikan dapat meningkatkan laba pada ekuitas pengguna."
      },
      {
        title: "Daftar Produk CFD",
        content:
          "Trading CFD dengan Topgrowth berarti pengguna dapat membeli dan menjual saham Amerika, Inggris, Eropa, Cina, dan Jepang dari platform yang sama. Seluruh produk CFD yang dapat diperdagangkan melalui Topgrowth tercantum pada tabel di bawah ini. Selain itu, Topgrowth juga menyertakan informasi untuk setiap produk, mata uang yang relevan, dan persyaratan margin untuk memperdagangkan setiap kontrak.\r\n            "
      },
      { title: "CFDs Pada Index", table: [] },
      { title: "CFDs Pada Produk Energi", table: [] },
      { title: "CFDs Pada Bullion Produk / Precious Metal", table: [] }
    ]
  },
  Gold: {
    header: "Gold",
